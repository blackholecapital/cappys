/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.toml worker/worker-configuration.d.ts` (hash: 811dc68cfc59213f44ffa1e47ec0726a)
// Runtime types generated with workerd@1.20260826.1 2026-08-28 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ANALYTICS: AnalyticsEngineDataset;
	JOBS: Queue;
	TENANT_ID: "cappys-electrical";
	ALLOWED_ORIGIN: "https://cappys.blackholecapital.xyz";
	EILA_RUNTIME_URL: "";
	APP_ORIGIN: "https://cappys.blackholecapital.xyz";
	PAYME: Fetcher /* checkout-worker */;
	VIDEO: Fetcher /* blackhole-video-worker */;
	VOICE: Fetcher /* blackhole-voice-worker */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TENANT_ID" | "ALLOWED_ORIGIN" | "EILA_RUNTIME_URL" | "APP_ORIGIN">> {}
}
